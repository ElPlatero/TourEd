    ...
    public partial class AddBliessteigProvider : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Abbreviation", "DataLicenseName", "DataLicenseUri", "DataSourceAttribution", "DataSourceRevision", "DataSourceUpdatedAt", "DataSourceUri", "Description", "IsAnonymousAccessAllowed", "Name", "Slug", "WebsiteUri" },
                values: new object[] { 7, "BS", "Creative Commons Namensnennung 4.0 International (CC BY 4.0)", "https://creativecommons.org/licenses/by/4.0/", "Saarpfalz-Touristik, Julia Serov; von TourEd aus den Etappenendpunkten abgeleitet", "f6ccf2af-e2e7-4bd1-becc-4590f8e3456a:2026-09-03T02:08:17", new DateTime(2026, 9, 3, 2, 8, 17, 0, DateTimeKind.Utc), "https://www.saarpfalz-touristik.de/touren/bliessteig-c62caf7374", "Der rund 106 Kilometer lange Bliessteig führt in neun Etappen von Sarreguemines durch den Bliesgau bis nach Bexbach. An den Etappenorten stehen 10 feste Stempelstationen.", true, "Bliessteig", "bliessteig", "https://www.saarpfalz-touristik.de/erlebnisse/wandern/wanderservice/stempelstationen" });

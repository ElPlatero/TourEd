...
TourEd is publicly available under the GNU Affero General Public License version 3 only (`AGPL-3.0-only`). Organizations that do not want to comply with the AGPL's requirements may request a separate commercial license from the copyright holder.
